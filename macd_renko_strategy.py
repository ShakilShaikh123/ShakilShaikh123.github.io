...
key_path = "/Users/shakil/Documents/AlgoTradingTutorial/algotrader/key.txt"
# ts = TimeSeries(key='S6ZKMPYARXD79JGM', output_format='pandas')
...
while len(tickers) != 0 and attempt <=5:
    ...
    for i in range(len(tickers)):        
        try:
            ...
            ohlc_intraday[tickers[i]] = yf.download(tickers[i],period='7d' , interval='5m')
